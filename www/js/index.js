...
var app7 = new Framework7({
  ...
  function Ingresar(){
   ...
   var correo = $$('#correo').val();
    ...
    app7.request({
      url: 'http://hoopbazar.com/hoop/api/login.php',
...
function Registrarse(){
  ...
  app7.request({
    url: 'http://hoopbazar.com/hoop/api/users.php',
  ...
  function getPromo(){
    ...
    app7.request({
      url: 'http://hoopbazar.com/hoop/api/promociones.php',
      data:{},
      method:'POST',
      crossDomain: true,
      success:function(data){
  ...
  function getProductos(){
    ...
    app7.request({
      url: 'http://hoopbazar.com/hoop/api/productos.php',
      data:{},
      method:'POST',
      crossDomain: true,
      success:function(data){
  ...
  $$(document).on('page:init', '.page[data-name="producto"]', function (e) {
    ...
    app7.request({
      url: 'http://hoopbazar.com/hoop/api/producto.php',
      data:{id:idproducto},
      method:'POST',
      crossDomain: true,
      success:function(data){
